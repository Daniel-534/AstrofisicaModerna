...
\input{Clases/Figuras/FigurasClaseTaller2/Fig1}

Como la luz se propaga con rapidez $c$, después de un tiempo $t$ la posición del frente que avanza hacia la derecha es
\[
x=ct.
\]
...
\input{Clases/Figuras/FigurasClaseTaller2/Fig2}

El segundo postulado exige que $S'$ también mida la rapidez $c$. Por tanto, para el frente que avanza hacia $+x'$:
\[
x'=ct'.
\]
...
\input{Clases/Figuras/FigurasClaseTaller2/Fig3}

Para $\beta=-0.8$ se tiene $\gamma=1/\sqrt{1-\beta^2}=5/3$. Además,
\[
ct=(299\,792.458\ \mathrm{km/s})(0.5\times10^{-3}\ \mathrm{s})
\approx149.9\ \mathrm{km}.
\]
Aplicando las transformaciones de Lorentz:
\[
\begin{aligned}
x'&=\gamma(x-\beta ct)
\approx\frac53\,[100-(-0.8)(149.9)]
\approx366.5\ \mathrm{km},\\
ct'&=\gamma(ct-\beta x)
\approx\frac53\,[149.9-(-0.8)(100)]
\approx383.2\ \mathrm{km},\\
t'&=\frac{ct'}{c}\approx1.278\ \mathrm{ms}.
\end{aligned}
\]
Las coordenadas transversales no cambian: $y'=10$ km y $z'=1$ km.
...
\input{Clases/Figuras/FigurasClaseTaller2/Fig4}

Como $ct\approx299.792$ km, la ecuación espacial permite determinar $\beta$:
\[
35.354
=\frac{5-299.792\beta}{\sqrt{1-\beta^2}}
\qquad\Longrightarrow\qquad
\beta\approx-0.10065.
\]
Por tanto,
\[
v=\beta c\approx-0.10065c.
\]
Finalmente, al transformar la coordenada temporal,
\[
\begin{aligned}
ct'&=\gamma(ct-\beta x),\\
t'&=\frac{ct'}{c}\approx\boxed{1.0068\ \mathrm{ms}}.
\end{aligned}
\]
